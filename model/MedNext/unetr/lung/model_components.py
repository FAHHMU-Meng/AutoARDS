...
from basic_model.unetr.layers import LayerNorm
from basic_model.unetr.lung.transformerblock import TransformerBlock
from basic_model.unetr.dynunet_block import get_conv_layer, UnetResBlock
...
class UnetrUpBlock_S(nn.Module):
    def     __init__(
            self,
            spatial_dims: int,
            in_channels: int,
